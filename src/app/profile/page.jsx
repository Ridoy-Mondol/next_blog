...
function Page() {
  ...
  if (!user) {
    return (
      <>
        <Navbar />
        <div className="flex flex-col items-center justify-center min-h-screen px-4 bg-gradient-to-b from-gray-100 to-white text-center">
          <div className="max-w-md w-full bg-white shadow-lg rounded-2xl p-8">
            ...
            <Link
              href="/login"
              className="inline-block w-full px-6 py-3 bg-blue-600 text-white font-semibold rounded-xl shadow hover:bg-blue-700 transition duration-200 text-center"
            >
      ...
      <div className="profile-div position-relative">
        ...
        <div className="profile-card">
          <div className="profile-image" onClick={() => setShowImg(true)}>
            <Image
              src={
                user?.profileImage != null ? user?.profileImage : profileImage
              }
              alt="Profile"
              width="1000"
              height="1000"
          ...
          <div className="profile-info">
            ...
            <p>
              Total Posts:{" "}
              {posts.filter((post) => post.user?.author === author).length}
            </p>
          </div>
        </div>

        <div
          className={`position-absolute update-profile-name update-name ${
            showImg ? "" : "d-none"
          }`}
        >
