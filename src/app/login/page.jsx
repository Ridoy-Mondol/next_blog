        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="md:col-span-1">
            <form className="my-auto p-0 text-start" onSubmit={handleSubmit}>
              ...
              <button type="submit" className="btn-1 reg-btn">
                LOG IN
              </button>
            </form>
            ...
            <p className="mt-3 text-start">
              <Link
                ...
                className="hover:underline redirect"
              >
                Forgot Password?
              </Link>
            </p>
            <p className="mt-2 text-start">
              <span className="reg-bold">Don&apos;t have an account?</span>
              <Link href="/signup" className="redirect hover:underline">
                {" "}
                Signup Now
              </Link>
            </p>
